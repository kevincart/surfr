...
function surfingManOpenmoji() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72">
      ...
      ></path>
      <g fill="#FCEA2B">
        <circle cx="35.969" cy="11.094" r="3"></circle>
        <path d="M45 23v24l-2 13h-3V47l-2-8h-1l-6 8-4 10h-3l2-13 6-9 2-5v-5l-2.916-1.75s-1.707-.583-3.999.625-5.584 1.958-7.084 2.125-6.69 0-7.125 0C11.709 26 11 25.334 11 24.042c0 0 8.584-.043 10.25-.626s10.25-4.083 10.25-4.083L46.084 18l11.97 6.738 3.781 1.679s-.377 1.875-2.897 1.114c-2.275-.686-6.271-2.531-9.876-5.031-.65-.45-3.124-1.094-3.124.5"></path>
      </g>
...
export default surfingManOpenmoji;